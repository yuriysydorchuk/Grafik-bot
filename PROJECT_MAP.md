...
| Google Drive (витяги) | `services/bankStatements.ts` | читання MT940 з папки `WB {MM.YYYY}/{юрособа}` (service account, `BANK_STATEMENTS_FOLDER_ID`); Kokos — чужий бізнес, пропускається |
