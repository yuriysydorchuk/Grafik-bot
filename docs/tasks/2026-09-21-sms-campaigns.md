...
- **Статус:** 🔄 в роботі — батчі 1–2 зроблено 21.09; далі батч 3 (панель)
- **Дата:** 2026-09-21
...
- **Зроблено:** пропозиція узгоджена; батчі 1–2 закомічено 21.09 (ядро, публічна сторінка, бот).
- **Лишилось:** батч 3 (панель), батч 4 (автоматика/звіти), батч 5 (прод/ключі/тест 300).
