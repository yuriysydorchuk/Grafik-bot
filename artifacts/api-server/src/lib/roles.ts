...
export const PAGE_KEYS = [
  ...
  "/hours", "/absences", "/advances", "/trips", "/mileage", "/reports", "/finance", "/bank", "/cash", "/cashflow", "/balance", "/obligations", "/invoices", "/pnl", "/payroll", "/svodni", "/hostels", "/penalties", "/ksef", "/settings",
