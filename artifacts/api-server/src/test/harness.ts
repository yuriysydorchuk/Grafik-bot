...
import {
  ...
  driverShiftAssignmentsTable, svodniRowsTable, svodniTabChecksTable,
} from "@workspace/db";
...
export {
  ...
  driverWorkdaysTable, driverShiftAssignmentsTable, svodniRowsTable, svodniTabChecksTable,
};
