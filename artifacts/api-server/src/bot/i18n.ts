...
const D: Dict = {
  ...
  "wabs.hint":      { uk: "\n\n_Виправданими пропуски визнає адміністратор після вашого пояснення. Пояснити пропуск можна лише один раз._", en: "\n\n_The administrator marks absences as justified after your explanation. Each absence can be explained only once._", es: "\n\n_El administrador marca las ausencias como justificadas tras tu explicación. Cada ausencia se explica una sola vez._", ru: "\n\n_Уважительными пропуски признаёт администратор после вашего объяснения. Объяснить пропуск можно только один раз._", pl: "\n\n_Nieobecności usprawiedliwia administrator po Twoim wyjaśnieniu. Każdą nieobecność można wyjaśnić tylko raz._" },
