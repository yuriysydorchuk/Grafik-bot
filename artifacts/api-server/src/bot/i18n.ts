...
const D: Dict = {
  ...
  "sign.newContract":  { uk: "📄 Вам надіслано умову на підписання. Перегляньте й підпишіть за посиланням:\n{link}\n\nЛінк дійсний 72 години.\n\n💡 Якщо сторінка відкрилась у вбудованому вікні Telegram — угорі праворуч натисни ••• → «Відкрити в Safari» (iPhone) або «Відкрити в браузері» (Android): підпис буде чіткішим.", en: "📄 A contract has been sent to you for signing. Review and sign via the link:\n{link}\n\nThe link is valid for 72 hours.\n\n💡 If the page opens inside Telegram's built-in browser — tap ••• in the top-right corner → \"Open in Safari\" (iPhone) or \"Open in browser\" (Android): the signature will be smoother.", es: "📄 Se te ha enviado un contrato para firmar. Revísalo y fírmalo en el enlace:\n{link}\n\nEl enlace es válido por 72 horas.\n\n💡 Si la página se abre dentro del navegador integrado de Telegram — toca ••• en la esquina superior derecha → «Abrir en Safari» (iPhone) o «Abrir en el navegador» (Android): la firma quedará más nítida.", ru: "📄 Вам отправлен договор на подписание. Просмотрите и подпишите по ссылке:\n{link}\n\nСсылка действительна 72 часа.\n\n💡 Если страница открылась во встроенном окне Telegram — нажми ••• вверху справа → «Открыть в Safari» (iPhone) или «Открыть в браузере» (Android): подпись будет чётче.", pl: "📄 Wysłano Ci umowę do podpisania. Sprawdź i podpisz przez link:\n{link}\n\nLink jest ważny 72 godziny.\n\n💡 Jeśli strona otworzy się we wbudowanej przeglądarce Telegram — kliknij ••• w prawym górnym rogu → „Otwórz w Safari” (iPhone) lub „Otwórz w przeglądarce” (Android): podpis będzie wyraźniejszy." },
...
const BOT_EN: Record<string, string> = {
  ...
  "нічого немає": "nothing", "ще": "and", "у панелі": "more in the panel", "Задачу створено": "Task created", "перенесено на завтра": "moved to tomorrow",
