...
// Дзеркало api-server/src/services/stayArticles.ts (той самий масив; правити синхронно).
...
export const STAY_ARTICLE_OPTIONS = STAY_ARTICLES.map(a => ({ value: a.code, label: a.label }));
